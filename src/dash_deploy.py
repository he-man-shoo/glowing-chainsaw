...
#--------------------------------------------------- Cost Memo
    ...
    return fig, bol_config, aug_energy_table, power_energy_rte_table, bill_of_materials, design_summary, losses_table, \
        bol_design_summary, plot_title, y_axis_range, months_to_COD, block_type, cost_memo_table
...
def update_output(proj_location, proj_name, power_req, duration, number_cycles, point_of_measurement, RMU_Required, PF_required_at_POM, max_site_temp, oversize_required, project_life, number_of_augmentations, flat_guarantee, n_clicks):
    ...
    if n_clicks:
        ...
        fig, bol_config, aug_energy_table, power_energy_rte_table, bill_of_materials, design_summary, losses_table, bol_design_summary, plot_title, y_axis_range, months_to_COD, block_type, cost_memo_table = calculation(proj_location, proj_name, power_req, duration, number_cycles, point_of_measurement, RMU_Required, PF_required_at_POM, max_site_temp, oversize_required, project_life, number_of_augmentations, flat_guarantee)
    ...
    losses_table_stored, bol_design_summary_stored, aug_energy_table_stored, power_energy_rte_table_stored, plot_title, y_axis_range, months_to_COD, block_type, cost_memo_table_stored, n_clicks
